// modules/consumption/budget_management_group.bicep
// Budget Azure Consumption au scope Management Group.
...
@description('ID du management group cible.')
output managementGroupId string = managementGroup().name

@description('Scope effectif du budget.')
output scope string = tenantResourceId('Microsoft.Management/managementGroups', managementGroup().name)
