/*
04_KeyVault_Policy.bicep - Initiative regroupant la policy intégrée "Azure Key Vault should use RBAC permission model"

Ce template crée une initiative (Policy Set Definition) au niveau de l'abonnement et l’assigne à l’abonnement. 
