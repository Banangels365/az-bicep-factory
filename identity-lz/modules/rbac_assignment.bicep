...
@description('Périmètre de l\'affectation de rôle (ex: resource group, subscription, ou ressource spécifique)')
...
// Optionnel : ID de la ressource d'identité managée déléguée pour les affectations de rôle nécessitant une identité managée
@description('ID de la ressource d\'identité managée déléguée')
...
resource roleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(principalId, roleDefinitionId, assignmentScope)
  properties: union(
    {
